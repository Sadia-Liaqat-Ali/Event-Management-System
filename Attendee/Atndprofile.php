...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        echo "<script>
                ...
                window.location.href = 'attendee_dashboard.php';
              </script>";
...
<button type="submit" style="background-color: blue; color:white; padding:10px 20px; border:none; border-radius:5px;">Update Event</button>
    </form>
</div>
